...
CompanyOutstanding.defaultProps = {
  ...
  members: [
    new CompanyPersonModel(1, 'Thị Dũng', 'CEO', 'asset/pictures/member/person_6.jpg', 'https://www.google.com'),
    new CompanyPersonModel(2, 'Đức Dương', 'HR', 'asset/pictures/member/person_6.jpg', 'https://www.google.com'),
    new CompanyPersonModel(3, 'Thị Anh', 'Checker', 'asset/pictures/member/person_6.jpg', 'https://www.google.com'),
    new CompanyPersonModel(4, 'Thị Đăng', 'COO', 'asset/pictures/member/person_6.jpg', 'https://www.google.com'),
    new CompanyPersonModel(4, 'Thị Huy', 'DEV', 'asset/pictures/member/person_6.jpg', 'https://www.google.com'),
  ]
};
