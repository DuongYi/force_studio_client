    ...
    <div className="max-w-screen-2xl w-full mx-auto px-4 py-32">
      <div className="flex-1 w-1/2">
        ...
        <p className="text-lg text-black mt-8">
          Since our foundation in 2019, we have put our heart and soul into what we enjoy the most, Video Games. We contribute the best of ourselves, understanding each project as an exciting challenge that we face with enthusiasm, perseverance, and seriousness.
        </p>
        <h2 className="text-xl pt-10 pb-3">
          Cùng nhau sáng tạo!
        </h2>
